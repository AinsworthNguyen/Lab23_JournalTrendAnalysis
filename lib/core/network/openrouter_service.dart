...
class OpenRouterService {
  ...
  Future<Map<String, dynamic>?> summarizeAbstract(
    final String abstractText,
  ) async {
    try {
      final SharedPreferences prefs = await SharedPreferences.getInstance();
      final String userKey = prefs.getString('openrouter_api_key') ?? '';
      final String apiKey = userKey.isNotEmpty ? userKey : _defaultKey;
      ...
      if (responseData is Map<String, dynamic>) {
        final List<dynamic> choices =
            responseData['choices'] as List<dynamic>? ?? <dynamic>[];
